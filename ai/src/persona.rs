...
/* 
  ...
  The db_map_container belongs the owner having its unique relationships Kp Ids and the
  ...
  = onwer hardware id, &v[2] = onwer Kp certified security level. Its relationship key id has
  &v[0] = relationship with the owner, &v[1] = the persona hardware id, &v[2] = persona Kp
